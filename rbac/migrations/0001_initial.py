# Generated by Django 3.0.7 on 2020-08-03 10:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.TextField(blank=True, default='/media/default/avatar.png', null=True, verbose_name='头像')),
            ],
            options={
                'verbose_name': '用户信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='rbac.Dict', verbose_name='父')),
            ],
            options={
                'verbose_name': '字典',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='rbac.DictType', verbose_name='父')),
            ],
            options={
                'verbose_name': '字典类型',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='rbac.Organization', verbose_name='父')),
            ],
            options={
                'verbose_name': '组织架构',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deleted', models.BooleanField(default=False, help_text='删除标记', verbose_name='删除标记')),
                ('name', models.CharField(max_length=30, verbose_name='名称')),
                ('type', models.CharField(choices=[('平台', '平台'), ('目录', '目录'), ('菜单', '菜单'), ('接口', '接口')], default='接口', max_length=20, verbose_name='类型')),
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='rbac.Permission', verbose_name='父')),
            ],
            options={
                'verbose_name': '功能权限表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=50, null=True, verbose_name='描述')),
                ('depts', models.ManyToManyField(blank=True, to='rbac.Organization', verbose_name='权限范围')),
                ('perms', models.ManyToManyField(blank=True, to='rbac.Permission', verbose_name='功能权限')),
            ],
            options={
                'verbose_name': '角色',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='rbac.Dict', verbose_name='父')),
                ('type', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='rbac.DictType', verbose_name='类型')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('path', models.TextField(blank=True, null=True, verbose_name='地址')),
        ...
        migrations.AddField(
            model_name='dict',
            name='type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rbac.DictType', verbose_name='类型'),
        ),
        migrations.AddField(
            model_name='user',
            name='dept',
            field=models.ForeignKey(blank=True, default=1, null=True, on_delete=django.db.models.deletion.SET_NULL, to='rbac.Organization', verbose_name='组织'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
